...
namespace JokesWebApp.Controllers
{
    public class JokesController : Controller
    {
        ...
        public async Task<IActionResult> ShowSearchResults(String? SearchPharse)
        {
            ...
            var joke = await _context.Joke.Where(x=> x.JokeQuestion.Contains(SearchPharse)).ToListAsync();
            if (joke == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Create([Bind("Id,JokeQuestion,JokeAnswer,Description,CreatedDateTime")] Joke joke)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,JokeQuestion,JokeAnswer,Description,CreatedDateTime")] Joke joke)
        {
            if (id != joke.Id)
            {
                return NotFound();
